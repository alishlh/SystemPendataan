...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Form Tambah Agen</div>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_agen') is-invalid @enderror" 
                               id="nama_agen" name="nama_agen" value="{{ old('nama_agen') }}" required>
                        @error('nama_agen')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email_agen') is-invalid @enderror" 
                               id="email_agen" name="email_agen" value="{{ old('email_agen') }}" required>
                        @error('email_agen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('kontak_agen') is-invalid @enderror" 
                               id="kontak_agen" name="kontak_agen" value="{{ old('kontak_agen') }}" required>
                        @error('kontak_agen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('alamat_agen') is-invalid @enderror" 
                                  id="alamat_agen" name="alamat_agen" rows="3" required>{{ old('alamat_agen') }}</textarea>
                        @error('alamat_agen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
